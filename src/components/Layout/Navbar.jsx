      ...
      <div className="bg-green-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                  ...
                  >
                    <div className="p-3">
                      {loading ? (
                        ...
                        <p className="text-red-600 text-center py-2 text-sm">
                        ...
                        >
                          {courses.map((course) => (
                            ...
                            >
                              <Link
                                to={`/courses/${course.slug}`}
                                className="block px-3 py-2 text-gray-800 text-sm font-medium rounded-md transition-all duration-300 hover:bg-green-50 hover:text-green-700 relative overflow-hidden group"
                              >
          ...
          <div className="hidden lg:flex items-center text-white">
            <Link
              to="/contact"
              className="flex items-center font-bold hover:text-green-200 transition"
            >
              <FaPhone className="mr-2 rotate-90" /> Contact Us
            </Link>
          </div>
              ...
              <div className="px-6 pb-6 space-y-4">
                    ...
                    {showMobileCoursesDropdown && (
                      ...
                      >
                        {loading ? (
                          ...
                          <div className="py-2 text-sm text-red-300">
                            Error loading courses
                          </div>
                        ) : courses.length === 0 ? (
                          <div className="py-2 text-sm text-gray-300">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <motion.div
                      animate={{
                        rotate: showMobileCertificatesDropdown ? 180 : 0,
                      }}
                      transition={{ duration: 0.3 }}
                    >
                      <FaChevronDown className="ml-2 text-sm" />
