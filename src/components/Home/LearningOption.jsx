...
function LearningOption() {
  ...
  <div className="w-full mx-auto">
    ...
    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 text-gray-800">
      <span className="text-green-600">Delivery Modes</span>
    </h2>
    </div>
    {/* Full-width grid */}
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6">
      {[
        ...
        >
          ...
          <h4 className="font-bold text-base sm:text-lg mb-2 text-gray-800">
            {item.title}
          </h4>
          <p className="text-xs sm:text-sm text-gray-650">{item.desc}</p>
        </div>
      ))}
    </div>
      <div className="text-center">
