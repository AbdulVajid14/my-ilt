...
const ILTSection = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 py-10 text-left">
      <h2 className="text-2xl md:text-3xl font-medium leading-tight mb-4">
        Best Digital Marketing Institute & Training Course in Cochin (Kochi), Kerala – 
      ...
      <p className="font-medium text-base md:text-lg leading-7 text-black">
        ...
        first digital marketing institute with 2000+ reviews and a 95% placement 
      ...
      <p className="font-medium text-base md:text-lg leading-7 text-black mt-4">
        ...
        owners generate quality leads, empowers professionals with real skills, and 
