...
function StudyAbroad() {
  return (
    ...
    <section
      ...
      style={{
        backgroundImage: "url('/images/Group 99.png')",
      }}
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center md:items-start justify-center text-center md:text-left px-4 md:px-8">
        <div className="w-full md:w-2/3">
          ...
          <div className="flex flex-wrap justify-center md:justify-start items-center text-white text-base sm:text-lg mb-6 sm:mb-8">
            {[
              { code: "GB", name: "UK" },
              { code: "CA", name: "Canada" },
              { code: "NZ", name: "New Zealand" },
              ...
              <span key={idx} className="mx-2 flex items-center">
                <ReactCountryFlag
                  countryCode={country.code}
                  svg
