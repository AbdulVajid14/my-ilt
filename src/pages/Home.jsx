...
//   if (error) {
//     return (
//       <div className="w-full h-130 flex items-center justify-center bg-red-100 text-red-600">
...
//         <section
//           key={banner.id || index}
//           className="relative text-white min-h-[400px] sm:min-h-[500px] flex items-center overflow-hidden"
//         >
//           <div
...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50 font-sans">
      {/* 1. Hero Section */}
      {loading ? (
        <div className="w-full h-130 bg-gray-200 animate-pulse"></div>
      ) : error ? (
        // Fallback UI for banner section on error
        <section
          className="relative text-white min-h-[400px] sm:min-h-[500px] flex items-center overflow-hidden"
        >
          <div
