...
//       {/* Trainer Info Section - max-w-7xl */}
...
//           <h2 className="text-3xl font-extrabold mb-1">David Mathews</h2>
//           <p className="text-gray-500 mb-6">
//             Senior Digital Marketing Strategist
//           </p>
//           <p className="mb-8 text-gray-800 leading-relaxed">
//             Highly experienced digital marketing strategist with strong
//             expertise in SEO and Social Media Marketing. He brings years of
//             industry knowledge into his sessions, helping learners master
//             practical strategies that align with the latest trends. His teaching
//             approach focuses on real-world applications, ensuring students gain
//             the confidence to implement what they learn.
//           </p>
...
//       {/* Courses & Education Section - max-w-7xl */}
//       <section className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
//         {/* Education & Skills Card */}
//         <div className="bg-white shadow-lg rounded-lg p-8 w-full md:w-1/3">
//           <h3 className="text-2xl font-bold mb-6">Education</h3>
//           <p className="flex items-center gap-2 mb-8 text-lg font-semibold">
//             <svg
...
//               />
//             </svg>
//             MBA in Marketing, Christ University, Bangalore
//           </p>

//           <h3 className="text-2xl font-bold mb-6">Skills</h3>
//           <div className="bg-green-50 p-6 rounded-lg grid grid-cols-2 gap-4 text-center text-sm max-w-xs">
//             <span className="border border-green-500 rounded-full py-1 px-3 inline-block">
//               SEO Optimization
//             </span>
//             <span className="border border-green-500 rounded-full py-1 px-3 inline-block">
