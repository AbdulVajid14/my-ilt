  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div
        ...
        style={{
          backgroundImage: "url('/images/WhatsApp Image 2025-10-08 at 17.29.14_a33a28ea.jpg')",
        }}
      >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 p-8 bg-white shadow-2xl rounded-xl">
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl font-bold text-gray-800">Address</h2>
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl font-bold text-gray-800">Contact Info</h2>
            <div className="text-gray-600 space-y-2">
              <p>
                <span className="font-semibold text-gray-900">Phone: </span> 
                <a href="tel:+914844038845" className="hover:text-blue-500 transition">+91 484 4038845</a>
              </p>
              <p>
                <span className="font-semibold text-gray-900">Mobile: </span> 
                <a href="tel:+919539070845" className="hover:text-blue-500 transition">+91 95390 70845</a>
              </p>
              <p>
                <span className="font-semibold text-gray-900">Email: </span> 
                <a href="mailto:info@internetleadstraining.com" className="text-blue-600 hover:text-blue-800 transition">
          ...
          <div className="flex flex-col items-start md:items-center">
            <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4">Follow Us</h2>
